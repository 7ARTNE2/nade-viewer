...
export function getClusterGrenades(map: string, clusterId: string, filters: MapFilters, limit = 80, offset = 0) {
  return invoke<GrenadePreview[]>("get_cluster_grenades", { map, clusterId, filters, limit, offset });
}

export function getThrowClusterGrenades(map: string, clusterId: string, filters: MapFilters, limit = 80, offset = 0) {
  return invoke<GrenadePreview[]>("get_throw_cluster_grenades", { map, clusterId, filters, limit, offset });
}
