...
export default function ThrowKeyIcon({ glyph }: Props) {
  ...
  return <svg className="throw-key-svg" viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="3.5" width="16" height="17" rx="3" /><path d="M7.5 7h9M7.5 10.5h9M7.5 14h5M14.5 14h2" /></svg>;
}
