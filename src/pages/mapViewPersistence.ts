...
export const defaultMapFilters = (): MapFilters => ({ grenade_type: "smoke", side: "T", search: "", min_usage: 0, is_core: false });
...
export function writeStoredMapViewState(key: string, state: StoredMapViewState) {
  try {
